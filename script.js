...
const products = [
  ...
  {id:2,name:"Bóp Bút/ Viết",category:"Bóp / Ví",price:79000,icon:"💝",desc:"Dung tích lớn, nhiều công dụng"},
  {id:3,name:"Ví Vải Thô/Canvas",category:"Bóp / Ví",price:149000,icon:"👛",desc:"Gọn gàng, tiện mang theo"},
  {id:4,name:"Cột Tóc Scrunchies",category:"Phụ kiện tóc",price:20000,icon:"🎀",desc:"Vải Xô Muslim/ Thô"},
  {id:5,name:"Kẹp Tóc Handmade",category:"Phụ kiện tóc",price:25000,icon:"🌼",desc:"Điểm nhấn nhẹ nhàng"},
  {id:6,name:"Dây Chuyền",category:"Trang sức",price:15000,icon:"📿",desc:"Phụ kiện xinh xắn, thu hút tài lộc"},
  {id:7,name:"Móc khóa Handmade",category:"Móc khóa",price:9000,icon:"🔑",desc:"Món quà nhỏ đáng yêu"},
  {id:8,name:"Gối Ghim Kim",category:"Gối ghim kim",price:49000,icon:"🧵",desc:"Bạn đồng hành cho góc may vá"},
  {id:9,name:"Phụ Kiện DIY",category:"DIY",price:9900,icon:"🧶",desc:"Tự tay làm món đồ của bạn"},
  {id:10,name:"Túi Đựng Đồ Cá Nhân",category:"Túi",price:39000,icon:"👜",desc:"Nhỏ gọn cho những ngày xinh"},
